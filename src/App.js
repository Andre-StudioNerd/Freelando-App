...
import { ProvedorTema } from "./componentes/Tema/Tema";
import { Tipografia } from "./componentes/Tipografia/Tipografia";
import { Botao } from "./componentes/Botao/Botao";
import { Logo } from "./componentes/Icones/Logo";
import { Link } from "./componentes/Icones/Link";
    ...
    <ProvedorTema>
      ...
      <Rodape>
        <Container>
          <Row align="center">
            <Col>
              <Logo height={40} width={176} />
              <Tipografia variante="legenda" componente="legenda">
                Desenvolvido por André. Projeto fictício sem fins comerciais.
              </Tipografia>
            </Col>
            <Col style={{ textAlign: "right" }}>
              <Tipografia variante="legenda" componente="legenda">
